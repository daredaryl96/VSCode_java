...
public class Login {
    ...
    public void loginView() throws SQLException {
        ...
        username.setBounds(50, 130, 150, 50);
        frame.add(username);

        JTextField name = new JTextField();
        name.setBounds(50, 200, 150, 50);
        frame.add(name);
        ...
        login.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (username.isEmpty() || password.isEmpty()) {
                    ...
                    if (id == -1) {
                        JOptionPane.showMessageDialog(frame, "No User Found!!!", "Warning Message",
                                JOptionPane.WARNING_MESSAGE);
                    } else if (id == 0) {
                        JOptionPane.showMessageDialog(frame, "Wrong Password!!!", "Warning Message",
                                JOptionPane.WARNING_MESSAGE);
                    } else {
                ...
                try {
                    if (!surveyCode.isEmpty() && surveyCode.length() == 5) {
                        if (manage.check(surveyCode)) {
                            ...
                            JOptionPane.showMessageDialog(frame, "No Survey Available!!!", "Warning Message",
                                    JOptionPane.WARNING_MESSAGE);
                        }
                    }
                } catch (Exception e2) {
