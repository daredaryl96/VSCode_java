    ...
    public void signUpView() {
        ...
        submit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                char[] passtemp1 = uPassField.getPassword();
                String pass1 = new String(passtemp1);
                char[] passtemp2 = uPassField2.getPassword();
                String pass2 = new String(passtemp2);
                if (fname.isEmpty() || uname.isEmpty() || pass1.isEmpty() || pass2.isEmpty()) {
                    ...
                    if (pass1.equals(pass2)) {
                        try {
                            ...
                            uPassField.setText("");
                            uPassField2.setText("");
                            JOptionPane.showMessageDialog(frame, "User Created Succesfully!!!", "User Created",
                                    JOptionPane.PLAIN_MESSAGE);
                            frame.dispose();

                        } catch (SQLException e1) {
                            JOptionPane.showMessageDialog(frame, "Something went wrong!!!", "Warning Message",
                                    JOptionPane.WARNING_MESSAGE);
                        }

                    } else {
                        JOptionPane.showMessageDialog(frame, "Password Mismatch", "Warning Message",
                                JOptionPane.WARNING_MESSAGE);
                    }
                }
            }
